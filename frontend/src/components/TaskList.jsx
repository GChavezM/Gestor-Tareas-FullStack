...
import { TASk_STATUS, TASK_STATUS_LABELS } from '../constants/constants';
                ...
                <>
                    <div className="col-span-full">
                        <div className="mb-4 flex items-center gap-4">
                            {Object.keys(TASK_STATUS_LABELS).map(
                                (statusKey) => {
                                    const borderClass =
            ...
            {tasks.length === 0 ? (
                ...
                tasks.map((task) => {
                    ...
                    const transitionState =
                        STATUS_TRANSITION[task.status] || null;
                        ...
                        <div
                            ...
                            <div className="mt-5 flex gap-3">
                                ...
                                {task.status !== TASk_STATUS.COMPLETED && (
                                    <button className="bg-primary text-background-secondary hover:bg-primary-hover cursor-pointer rounded-md px-4 py-2 text-sm font-medium transition-all duration-200 ease-in-out">
                                        <FontAwesomeIcon
                                            className="mr-2"
                                            icon={faPencil}
                                        />
                                ...
                                {task.status === TASk_STATUS.COMPLETED && (
                                    <button className="bg-delete text-background-secondary hover:bg-delete-hover cursor-pointer rounded-md px-4 py-2 text-sm font-medium transition-all duration-200 ease-in-out">
                                        <FontAwesomeIcon
                                            className="mr-2"
                                            icon={faTrash}
                                        />
